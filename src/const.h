...
// PICKUP
constexpr BUTTON PICKUP_UP_BUTTON = BUTTON::COLORS_LEFT; //works
constexpr BUTTON PICKUP_DOWN_BUTTON = BUTTON::COLORS_DOWN; //works

// MULTIPLIER
constexpr BUTTON ELEV_UP_BUTTON = BUTTON::ARROW_UP; //works
constexpr BUTTON ELEV_DOWN_BUTTON = BUTTON::ARROW_DOWN; //works
...
constexpr BUTTON SORT_DIVERT_BUTTON = BUTTON::COLORS_RIGHT; //works
